...
export const templateSchema = z.object({
	...
	placeholderColor: zColor().describe(
		'لون النص التوضيحي داخل البطاقة الفارغة'
	),
	...
	saltWordIndexes: z
		...
		.describe(
			'أرقام الكلمات التي تُفعَّل عليها الأحرف المرسلة داخل كل مقطع، بدءاً من صفر. ' +
				'تُصفّى وفق دليل ثمانية: لا في كلمتين متجاورتين، ولا أكثر من واحدة لكل سطر، ' +
