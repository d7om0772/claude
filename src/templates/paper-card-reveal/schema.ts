...
export const paperCardSchema = z.object({
  ...
  brandName: z
    .string()
    .max(16)
    .describe('الووردمارك تحت الشعار. حد أقصى ١٦ حرفاً حتى لا يزدحم أعلى الإطار.'),
...
export type PaperCardProps = z.infer<typeof paperCardSchema>;

export const paperCardDefaultProps: PaperCardProps = {
