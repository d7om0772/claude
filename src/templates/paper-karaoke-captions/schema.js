...
export const templateSchema = z.object({
  ...
  subheadline: z
    ...
    .nullable()
    .describe(
      "سطر ثانوي صغير تحت الكابشن، يظهر طول المقطع. اتركه فارغاً لإخفائه",
    ),
  /* --------------------------------------------------------------- الكابشن */
  captions: z
    .array(captionSchema)
  ...
  fontSizeRatio: z
    ...
    .max(0.2)
    .describe(
      "حجم الخط كنسبة من ارتفاع الإطار (0.0474 = 91 بكسل في إطار 1920)",
    ),
  lineHeightRatio: z
    .number()
    .min(1)
  ...
  wordGapEm: z
    ...
    .max(1)
    .describe(
      "المسافة بين الكلمات بوحدة em (0.25 = عرض المسافة الأصلي في الخط)",
    ),
  /* ---------------------------------------------------------------- الحركة */
