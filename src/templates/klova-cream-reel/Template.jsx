    ...
    {src ? (
      isVideoSource(src) ? (
        <Video
          ...
          /**
           * مهلة أوسع من الافتراضية، للرندر الخادمي.
           *
           * تنبيه: الرندر داخل المتصفح لا يقرأ هذه الخاصية — مهلة انتظار
           * الفريم هناك تُضبط على renderMediaOnWeb نفسه في
           * src/ui/web-render.js، وهي الوحيدة التي تُحتسب.
           */
